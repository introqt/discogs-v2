    ...
    public function enqueueScripts(string $hook): void
    {
        ...
        wp_localize_script('ldg-admin', 'ldgAdmin', [
            ...
            'i18n' => [
                ...
                'enterKeywordOrFilter' => __('Please enter a keyword or at least one filter.', 'livedg'),
                'savedSearchNamePrompt' => __('Name this search:', 'livedg'),
                'cannotSaveEmptySearch' => __('Cannot save an empty search.', 'livedg'),
                'selectSavedSearch' => __('Select a saved search first.', 'livedg'),
                'confirmDeleteSavedSearch' => __('Delete this saved search?', 'livedg'),
                'savedSearchSaved' => __('Saved search.', 'livedg'),
                'savedSearchDeleted' => __('Saved search deleted.', 'livedg'),
                'year' => __('Year', 'livedg'),
